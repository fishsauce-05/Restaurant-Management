...
public class GuestStatFrm extends JFrame implements ActionListener {
        ...
        tblStat.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (row >= 0 && listStat != null && row < listStat.size()) {
                    ...
                    new GuestStatDetailFrm(selected.getTimeFrm(), txtStartDate.getText().trim(), txtEndDate.getText().trim()).setVisible(true);
                }
            }
        });
    ...
    private String getFrmFromTime(String time) {
